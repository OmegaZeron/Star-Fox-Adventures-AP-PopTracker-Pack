CustomItemProgressiveTogglePlus = class()

function CustomItemProgressiveTogglePlus:init()
end

function CustomItemProgressiveTogglePlus:createItem(name)
...
function CustomItemProgressiveTogglePlus:onLeftClick()
end

-- Called when your item is right-clicked
function CustomItemProgressiveTogglePlus:onRightClick()
end
...
function CustomItemProgressiveTogglePlus:canProvideCode(code)
	return false
end
...
function CustomItemProgressiveTogglePlus:providesCode(code)
	return 0
end

-- Called to request that your item advance to the given code.
function CustomItemProgressiveTogglePlus:advanceToCode(code)
end
...
function CustomItemProgressiveTogglePlus:load(data)
	return true
end
...
function CustomItemProgressiveTogglePlus:setProperty(key, value)
	return self.ItemInstance:Set(key, value)
end

-- Call to read a transaction-backed property. DO NOT OVERRIDE
function CustomItemProgressiveTogglePlus:getProperty(key)
...
function CustomItemProgressiveTogglePlus:propertyChanged(key, value)
end